    ...
    public partial class Forms : Form
    {
        ...
        private void AddSearchTextBoxes()
        {
            try
            {
                ...
                var labelTitleInvOld = tabPageInventory.Controls["labelTitleInv"];
                if (labelTitleInvOld != null)
                {
                    labelTitleInvOld.Location = new System.Drawing.Point(280, 10);
                }

                tabPageInventory.Controls.Add(searchBoxInv);
                tabPageInventory.Controls.Add(searchLabelInv);
                ...
                var labelTitleOrderOld = tabPageOrdering.Controls["labelTitleOrder"];
                if (labelTitleOrderOld != null)
                {
                    labelTitleOrderOld.Location = new System.Drawing.Point(280, 10);
                }

                tabPageOrdering.Controls.Add(searchBoxOrder);
                tabPageOrdering.Controls.Add(searchLabelOrder);

                // Add search for Shipping
                ...
                var labelTitleShipOld = tabPageShipping.Controls["labelTitleShip"];
                if (labelTitleShipOld != null)
                {
                    labelTitleShipOld.Location = new System.Drawing.Point(280, 10);
                }

                tabPageShipping.Controls.Add(searchBoxShip);
                tabPageShipping.Controls.Add(searchLabelShip);
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Error adding search: {ex.Message}");
            }
        }
        ...
        private void SetupInventoryDataGridView()
        {
            try
            {
                ...
                dgvItems.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "ID", DataPropertyName = "Id", Width = 40 });
                dgvItems.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Name", DataPropertyName = "Name", Width = 100 });
                dgvItems.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Code", DataPropertyName = "Code", Width = 80 });
                dgvItems.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Brand", DataPropertyName = "Brand", Width = 80 });
                dgvItems.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Unit Price", DataPropertyName = "UnitPrice", Width = 90 });
            ...
            {
                MessageBox.Show($"Error setting up inventory grid: {ex.Message}");
            }
        }
        ...
        private void SetupOrderDataGridView()
        {
            try
            {
                ...
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Item Code", DataPropertyName = "ItemCode", Width = 75 });
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Item Name", DataPropertyName = "ItemName", Width = 85 });
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Ordered By", DataPropertyName = "OrderedBy", Width = 80 });
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Quantity", DataPropertyName = "OrderedQuantity", Width = 70 });
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Unit Price", DataPropertyName = "UnitPrice", Width = 85 });
                dgvOrders.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Total", DataPropertyName = "TotalPrice", Width = 85 });

                dgvOrders.CellClick += DgvOrders_CellClick;
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Error setting up orders grid: {ex.Message}");
            }
        }
        ...
        private void SetupShippingDataGridView()
        {
            try
            {
                ...
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "ID", DataPropertyName = "Id", Width = 40 });
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Item Code", DataPropertyName = "ItemCode", Width = 75 });
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Item Name", DataPropertyName = "ItemName", Width = 85 });
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Ordered By", DataPropertyName = "OrderedBy", Width = 80 });
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Ship To", DataPropertyName = "ShippedTo", Width = 95 });
                dgvShippings.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Status", DataPropertyName = "Status", Width = 80 });

                dgvShippings.CellClick += DgvShippings_CellClick;
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Error setting up shipping grid: {ex.Message}");
            }
        }
        ...
        // SHIPPING: Only Update and Delete (suggested workflow)
        ...
        private async void BtnUpdateShipping_Click(object sender, EventArgs e)
        {
            ...
            if (newStatus == "Cancelled" && oldStatus != "Cancelled")
            {
                ...
                try
                {
                    // Step 1: Find and restore the associated order
                    ...
                    // Step 2: Update shipping status to Cancelled
